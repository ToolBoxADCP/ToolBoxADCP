function [jjadcpA]=datum(SerYear,SerMon,SerDay,SerHour,SerMin,SerSec);
% Attention les années sont en réalité : Year + 2000 %

jjadcpA=datenum(SerYear,SerMon,SerDay,SerHour,SerMin,SerSec);
